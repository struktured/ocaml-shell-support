...
(* OASIS_START *)
(* DO NOT EDIT (digest: d9d678f2b651fe1e94c371f19bd5d904) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = None;
          synopsis = "Ocaml scripts, for YJ developers";
          description = None;
          categories = [];
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Shell_utils"];
                      lib_pack = true;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "yj_scripts_common";
                      lib_findlib_containers = []
                   });
               Executable
                 ({
                     cs_name = "git_clean_repo";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      ...
                      bs_build_depends =
                        [InternalLibrary "yj_scripts_common"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
                   ...
                   {exec_custom = false; exec_main_is = "git_repo_clean.ml"})
            ];
          plugins =
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\183\152\254\1970\194g[%n\233\130\t\254\198\182";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
