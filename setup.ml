...
(* OASIS_START *)
(* DO NOT EDIT (digest: 6460404478fec7920909237cda8834d3) *)
(*
...
let setup_t =
  {
               ...
               Library
                 ({
                   ...
                   },
                   {
                      ...
                      lib_findlib_name = Some "shell_support";
     ...
     oasis_version = "0.4.5";
     oasis_digest =
       Some "\241\170\148\247\240\171\234L\0220\166\148\2464\016X";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
