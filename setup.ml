...
(* OASIS_START *)
(* DO NOT EDIT (digest: 5fb72fb7615a20acbd98c124d9039c88) *)
(*
...
let setup_t =
  {
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Shell"; "Wget"; "Decompress"; "Git"];
                      lib_pack = true;
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\163y\156\027\159ZN\207\211\234\127\152(T&\026";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
