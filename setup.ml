...
(* OASIS_START *)
(* DO NOT EDIT (digest: c04f04062072aef58b3e429f06042546) *)
(*
...
let setup_t =
  {
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Shell_utils"; "Wget"; "Decompress"];
                      lib_pack = true;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "yj_scripts";
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "|m\224=v\238\001\199)\003\021\138_st\165";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
