...
(* OASIS_START *)
(* DO NOT EDIT (digest: e3bb179906297312b2ed7c651019eb7f) *)
(*
...
let setup_t =
  {
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Shell"; "Wget"; "Decompress"];
                      lib_pack = true;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "ocaml_shell_support";
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "e\028}\181\250\198\252\178H1#\246\\\230\bp";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
